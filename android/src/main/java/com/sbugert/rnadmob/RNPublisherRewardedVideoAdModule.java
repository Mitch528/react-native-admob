...
public class RNPublisherRewardedVideoAdModule extends ReactContextBaseJavaModule implements RewardedVideoAdListener {
  ...
  public void requestAd(final Promise promise) {
    new Handler(Looper.getMainLooper()).post(new Runnable() {
      @Override
      public void run() {
        RNPublisherRewardedVideoAdModule.this.mRewardedVideoAd = MobileAds.getRewardedVideoAdInstance(getCurrentActivity());

        RNPublisherRewardedVideoAdModule.this.mRewardedVideoAd.setRewardedVideoAdListener(RNPublisherRewardedVideoAdModule.this);
